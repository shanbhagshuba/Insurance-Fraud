...
class Train_Model:
    ...
    def training_model(self):
        ...
        try:
            ...
            final_data,num_cols = self.data_preprocessing_obj.feature_engineering(self.file_object,data, unwanted_columns,self.Image_Folder)
            ...
            X,y = self.data_preprocessing_obj.feature_scaling_splitting(self.file_object,final_data,'fraud_reported','Mixed',mixed_minmax_cols , num_cols)
...
if __name__ == "__main__":
    ...
    train_validation_insertion_obj.train_validation_insertion('Insurance','tbl_training')
