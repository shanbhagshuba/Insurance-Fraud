...
class raw_data_validation:
    ...
    def input_file_validation(self,input_folder,json_file, good_data_folder, bad_data_folder, file_object):
        try:
            files = glob.glob(input_folder+"fraud*.csv", recursive=True)
            ...
            for filepath in files:
                ...
                if filename.split('_')[0] == 'fraudDetection' and len(filename.split('_')[1]) == LengthOfDateStampInFile and len(filename.split('_')[2]) == LengthOfTimeStampInFile and fileformat == 'csv':
